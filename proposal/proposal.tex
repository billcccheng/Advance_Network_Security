...
Basically every service today supports an on-demand access through all kinds of devices.
To meet this requirement, service providers tend to adopt the approach of rolling
out their initial products as
web applications.
\\\\
...
Secondly, the application can be patched instantely.
Every user has the same version of application any single time, and it relieves engineers from
...
This fast deployment, fast prototype, and light-weighted feature
greatly facilitates the time-to-market speed, and can get more instant
feedback from market, and alter its direction accordingly
\\\\
...
While engineers are busy on bringing out all the functionalities,
they may not have time to work on security. Which may lead to devastating
